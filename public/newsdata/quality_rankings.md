...
- Overall status: **FAIL**
- Overall score: `0.2924`

## Destination scores

| Destination | Status | Score | Profile | Ranked items |
|---|---|---:|---|---:|
| upAhead | WARN | 0.8254 | `upAhead-v2-lifecycle-location-category` | 30 |
| buzz | FAIL | 0.0 | `buzz-v2-trend-local-travel` | 0 |
| localTravel | FAIL | 0.0 | `localTravel-v1-location-utility-disruption` | 0 |
| insight | WARN | 0.3443 | `insight-v2-event-angle-tree` | 12 |

## Findings

- 39 invalid/expired/duplicate Up Ahead item(s) suppressed
...
- 9 base-report-heavy Insight parent(s) demoted
